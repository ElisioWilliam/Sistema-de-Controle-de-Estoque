    ...
    public void criarTabelas() {
        try {
            if (connection != null) {
                ...
                String createTablePedido = "CREATE TABLE IF NOT EXISTS pedido (id INTEGER PRIMARY KEY AUTOINCREMENT, id_pessoa INTEGER, id_produto INTEGER, quantidade_produto INTEGER, valor_total FLOAT)";
